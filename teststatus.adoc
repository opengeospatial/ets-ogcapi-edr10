...
|*Abstract Test 20* |*/conf/geojson/definition*| @ghobona  | Yes | `MediaType.validateResponseForGeoJSON`
|*Abstract Test 21* |*/conf/geojson/content*|  @ghobona  | Yes | `MediaType.validateResponseForGeoJSON`
|*Abstract Test 22* |*/conf/edr-geojson/definition*|  |  |
|*Abstract Test 23* |*/conf/edr-geojson/content*|  |  |
|*Abstract Test 24* |*/conf/covjson/definition*| @ghobona  | Yes | `MediaType.validateResponseForCoverageJSON`
|*Abstract Test 25* |*/conf/covjson/content*| @ghobona  | Yes | `MediaType.validateResponseForCoverageJSON`
