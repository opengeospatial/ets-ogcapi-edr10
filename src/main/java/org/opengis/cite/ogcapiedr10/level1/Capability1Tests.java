package org.opengis.cite.ogcapiedr10.level1;
...
import org.opengis.cite.ogcapiedr10.ErrorMessage;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.ogcapiedr10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/ogcapiedr10/rnc/atom.rnc");
