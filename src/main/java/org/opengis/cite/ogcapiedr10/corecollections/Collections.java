...
public class Collections extends CommonDataFixture {
	 ...
	 */
	@Test(description = "Implements Abstract Test 82, meets Requirement /req/collections/rc-md-op",
			dataProvider = "collectionsUris", dependsOnGroups = "conformance")
	 ...
	 * @param testPoint the test point to test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 15, meets Requirement /req/edr/rc-md-query-links",
			dataProvider = "collectionsUris", dependsOnMethods = "validateCollectionsMetadataOperation")
	 ...
	 * @param testPoint the test point to test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 16, meets Requirement /req/core/rc-collection-info-links",
			dataProvider = "collectionsUris", dependsOnMethods = "validateCollectionsMetadataOperation")
	public void validateCollectionsMetadata_Links(TestPoint testPoint) {
		...
		assertTrue(typesWithoutLink.isEmpty(),
				"Collections Metadata document must include links for alternate encodings. Missing links for types "
						+ typesWithoutLink);
