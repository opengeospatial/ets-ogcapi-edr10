...
public class TrajectoryCollections extends AbstractFeatures {
	 ...
	 * Abstract Test 52: Validate that the coords query parameters are constructed correctly. (trajectory)
	 * Abstract Test 74: Validate that the coords query parameters are constructed correctly. (trajectory)
	 * </pre>
	 *
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 36, Abstract Test 52, and Abstract Test 74, meets Requirement 3 /req/edr/coords-definition Parameter coords definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * Abstract Test 56: Validate that the dateTime query parameters are constructed correctly. (trajectory)
	 * Abstract Test 89: Validate that the dateTime query parameters are constructed correctly. (items)
	 * </pre>
	 *
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 40, Abstract Test 56, and Abstract Test 89, and meets Requirement 5: /req/core/datetime-parameter Datetime parameter", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * parameter-name query parameters are processed correctly. (trajectory) Abstract Test
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 42, Abstract Test 58, Abstract Test 76, and Abstract Test 103 and meets Requirement 6: /req/edr/parameter-name-definition Parameter parametername definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 44, Abstract Test 60, Abstract Test 78, and Abstract Test 105 and Requirement 8: /req/edr/crs-definition Parameter crs definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * Abstract Test 62: Validate that the f query parameter is constructed correctly. (trajectory)
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Abstract Test 46, Abstract Test 62, Abstract Test 80, Abstract Test 107 and Requirement 10: /req/edr/f-definition Parameter f definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * Abstract Test 54: Validate that the vertical level query parameters are constructed correctly. (trajectory)
	 *
	 *
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Abstract Test 38, Abstract Test 54 and Requirement 12: /req/edr/z-definition Parameter z definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 14: /req/edr/within-definition Parameter within definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryWithinParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 16: /req/edr/within-units-definition Parameter withinUnits definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryWithinUnitsParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 18: /req/edr/min-z-definition Parameter min-z definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryMinzParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 20: /req/edr/max-z-definition Parameter max-z definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryMaxzParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 22: /req/edr/resolution-x-definition Parameter resolution-x definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryResolutionxParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 24: /req/edr/resolution-y-definition Parameter resolution-y definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryResolutionyParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 26: /req/edr/resolution-z-definition Parameter resolution-z definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryResolutionzParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 28: /req/edr/corridor-height-definition Parameter corridor-height definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryCorridorHeightParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 30: /req/edr/corridor-width-definition Parameter corridor-width definition", dataProvider = "trajectoryCollectionPaths", alwaysRun = true)
	public void trajectoryCorridorWidthParameterDefinition(TestPoint testPoint) {
