...
public class CubeCollections extends AbstractFeatures {
	 ...
	 */
	@Test(description = "Implements Abstract Test 70/77 (/conf/edr/rc-coords-definition)",
			dataProvider = "cubeCollectionPaths", alwaysRun = true)
	public void cubeBboxParameterDefinition(TestPoint testPoint) {

		ct.bboxParameterDefinition(testPoint, this.getModel());
		System.gc();
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 74/81 (/conf/core/datetime-definition)",
			dataProvider = "cubeCollectionPaths", alwaysRun = true)
     ...
     * Abstract Test 83 (v1.0.1): Validate that the parameter-name query parameters are processed
	 * correctly. (cube)
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements 76/83 (/conf/collections/REQ_rc-parameter-name-definition)",
			dataProvider = "cubeCollectionPaths", alwaysRun = true)
     ...
     * Abstract Test 85 (v1.0.1): Validate that the crs query parameters are constructed correctly.
	 * (cube)
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 78/85 (/conf/edr/REQ_rc-crs-definition)",
			dataProvider = "cubeCollectionPaths", alwaysRun = true)
     ...
     * Abstract Test 87 (v1.0.1): Validate that the f query parameter is constructed correctly.
	 * (cube)
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 80/87 (/conf/edr/rc-f-definition)", dataProvider = "cubeCollectionPaths",
			alwaysRun = true)
	...
	/**
	 * Abstract Test 69 (v1.0.0),
     * Abstract Test 76 (v1.0.1): Validate that resources can be identified and extracted from a
	 * Collection with a Cube query using query parameters.
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Implements VerticalLevel check of Abstract Test 69/76 (/conf/cube)",
			dataProvider = "cubeCollectionPaths", alwaysRun = true)
