...
public class CollectionsTime {
	...
	public void coordsParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (!testPoint.getPath().endsWith("/locations")) {
			...
			if (coords != null) {
				...
				// assertEquals( coords.getStyle(), "form", String.format( msg,
				// "style","form",
	...
	public void bboxParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		assertNotNull(bbox, "Required " + paramName + " parameter for collections with path '" + testPoint.getPath()
	...
	public void withinUnitsParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (withinUnits != null) {
			String msg = "Expected property '%s' with value '%s' but was '%s'";
			assertEquals(withinUnits.getName(), paramName,
					String.format(msg, "name", paramName, withinUnits.getName()));
	...
	public void resolutionxParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (resolutionx != null) {
			String msg = "Expected property '%s' with value '%s' but was '%s'";
			assertEquals(resolutionx.getName(), paramName,
					String.format(msg, "name", paramName, resolutionx.getName()));
	...
	public void resolutionyParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (resolutiony != null) {
			String msg = "Expected property '%s' with value '%s' but was '%s'";
			assertEquals(resolutiony.getName(), paramName,
					String.format(msg, "name", paramName, resolutiony.getName()));
	...
	public void resolutionzParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (resolutionz != null) {
			...
			String msg = "Expected property '%s' with value '%s' but was '%s'";
			assertEquals(resolutionz.getName(), paramName,
					String.format(msg, "name", paramName, resolutionz.getName()));
	...
	public void corridorHeightParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (corridorHeight != null) {
			...
			assertTrue(isRequired(corridorHeight),
					String.format(msg, "required", "true", corridorHeight.getRequired()));
			assertEquals(corridorHeight.getStyle(), "form",
					String.format(msg, "style", "form", corridorHeight.getStyle()));
	...
	public void corridorWidthParameterDefinition(TestPoint testPoint, OpenApi3 model) {
		...
		if (corridorWidth != null) {
			...
			String msg = "Expected property '%s' with value '%s' but was '%s'";
			assertEquals(corridorWidth.getName(), paramName,
					String.format(msg, "name", paramName, corridorWidth.getName()));
			...
			assertEquals(corridorWidth.getStyle(), "form",
					String.format(msg, "style", "form", corridorWidth.getStyle()));
