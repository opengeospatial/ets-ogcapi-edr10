...
public class PositionCollections extends AbstractFeatures {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 14: /req/edr/within-definition Parameter within definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionWithinParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 16: /req/edr/within-units-definition Parameter withinUnits definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionWithinUnitsParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 18: /req/edr/min-z-definition Parameter min-z definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionMinzParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 20: /req/edr/max-z-definition Parameter max-z definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionMaxzParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 22: /req/edr/resolution-x-definition Parameter resolution-x definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionResolutionxParameterDefinition(TestPoint testPoint) {
 ...
 definition
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 24: /req/edr/resolution-y-definition Parameter resolution-y definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionResolutionyParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 26: /req/edr/resolution-z-definition Parameter resolution-z definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionResolutionzParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 28: /req/edr/corridor-height-definition Parameter corridor-height definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionCorridorHeightParameterDefinition(TestPoint testPoint) {
	 ...
	 * @param testPoint the testPoint under test, never <code>null</code>
	 */
	@Test(description = "Requirement 30: /req/edr/corridor-width-definition Parameter corridor-width definition", dataProvider = "positionCollectionPaths", alwaysRun = true)
	public void positionCorridorWidthParameterDefinition(TestPoint testPoint) {
