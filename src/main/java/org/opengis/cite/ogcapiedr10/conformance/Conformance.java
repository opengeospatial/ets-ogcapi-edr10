...
public class Conformance extends CommonFixture {
	...
	/**
	 * Abstract Test 6: Validate that a Conformance Declaration can be retrieved from the
	 * expected location. Abstract Test 7: Validate that the Conformance Declaration
	 * response complies with the required structure and contents.
	 * @param testPoint the test point to test, never <code>null</code>
	 */
	@Test(description = "Implements Abstract Test 6 (/conf/core/conformance) and Abstract Test 7 (/conf/core/conformance-success)",
