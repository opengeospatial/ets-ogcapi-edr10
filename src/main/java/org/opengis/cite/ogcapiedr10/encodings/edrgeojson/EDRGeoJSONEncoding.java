...
public class EDRGeoJSONEncoding extends CommonFixture {
	...
	public void validateResponseForEDRGeoJSON(Object collectionIdentifiers) {
	  ...
	  for (String collection : collectionTypes) {
	    ...
	    boolean returnsValidEDRGeoJSON = false;
	      ...
	      if(returnsValidEDRGeoJSON) supportsEDRGeoJSON = true;
	  ...
	  assertTrue(supportsEDRGeoJSON, "Fails Abstract Test 22 and 23, none of the collections appears to support valid EDR GeoJSON");
