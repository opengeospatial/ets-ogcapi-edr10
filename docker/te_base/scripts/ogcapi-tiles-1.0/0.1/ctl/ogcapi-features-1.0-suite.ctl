...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  <ctl:function name="tns:run-ets-ogcapi-tiles-1.0">
    ...
    <ctl:description>Runs the OGC API - Tiles (0.1-SNAPSHOT) test suite.</ctl:description>
    <ctl:code>
  ...
  <ctl:suite name="tns:ets-ogcapi-tiles-1.0-0.1-SNAPSHOT">
  ...
  <ctl:test name="tns:Main">
    ...
    <ctl:code>
      ...
      <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-ogcapi-tiles-1.0">
