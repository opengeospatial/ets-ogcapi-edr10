...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/ogcapi-edr10"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.ogcapiedr10.TestNGController">

  <ctl:function name="tns:run-ets-ogcapi-edr10">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the ogcapi-edr10 0.1-SNAPSHOT test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-ogcapi-edr10-0.1-SNAPSHOT">
     <ctl:title>OGC API - Environmental Data Retrieval 1.0 Conformance Test Suite</ctl:title>
	  ...
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>OGC API - Environmental Data Retrieval 1.0 Conformance Test Suite</h2>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-ogcapi-edr10">
